...
def test_given_cell_is_empty_and_only_one_option_exists_vertically_then_valid_is_returned():
    board = [
        0, 0,  3, 4,
        4, 3,  2, 1,
...
def test_given_cell_is_empty_and_multiple_options_exists_then_unknown_is_returned():
    board = [
        0, 2,  0, 4,
        4, 0,  2, 1,
